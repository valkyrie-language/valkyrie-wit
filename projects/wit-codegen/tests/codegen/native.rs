    ...
    pub mod native {
      ...
      pub mod number {
        ...
        const _: () = {
          ...
          #[doc(hidden)]
          #[export_name = "v:native/number#test"]
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_test() {
            ...
            let result0 = <_GuestImpl as Guest>::test();
            let Natural{ } = result0;
          }
        };
